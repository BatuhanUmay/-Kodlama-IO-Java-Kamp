...
import com.example.rentACar.core.utilities.exceptions.ValidationProblemsDetails;
...
public class RentACarApplication {
    ...
    public ProblemDetails handleValidationException(MethodArgumentNotValidException methodArgumentNotValidException) {
        ...
        validationProblemsDetails.setValidationErros(new HashMap<String, String>());

        for (FieldError fieldError : methodArgumentNotValidException.getBindingResult().getFieldErrors()) {
            validationProblemsDetails.getValidationErros().put(fieldError.getField(), fieldError.getDefaultMessage());
        }
